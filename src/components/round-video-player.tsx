...
const styles = StyleSheet.create({
  ...
  overlayTimer: { marginTop: 2, fontSize: 12, lineHeight: 14, fontFamily: 'Inter_800ExtraBold', fontWeight: '800', textAlign: 'center' },
  ...
  playPauseText: { color: colors.white, fontSize: 18, fontFamily: 'Inter_900Black', fontWeight: '900' },
  playbackTime: {
    minWidth: 38,
    color: colors.white,
    fontSize: 11,
